    ...
    private static <T> void applyConditions(QueryWrapper<T> wrapper, Map<String, String> propToColumn, List<QueryCondition> conditions) {
        ...
        for (QueryCondition c : conditions) {
            ...
            switch (c.getOperator()) {
                case EQ: if (value != null) wrapper.eq(column, value); break;
                case NE: if (value != null) wrapper.ne(column, value); break;
                case GT: if (value != null) wrapper.gt(column, value); break;
                case GTE: if (value != null) wrapper.ge(column, value); break;
                case LT: if (value != null) wrapper.lt(column, value); break;
                case LTE: if (value != null) wrapper.le(column, value); break;
                case LIKE: if (value != null) wrapper.like(column, value); break;
                case LIKE_LEFT: if (value != null) wrapper.likeLeft(column, value); break;
                case LIKE_RIGHT: if (value != null) wrapper.likeRight(column, value); break;
                case IN: if (value != null) wrapper.in(column, toCollection(value)); break;
                case NOT_IN: if (value != null) wrapper.notIn(column, toCollection(value)); break;
                case BETWEEN:
                    if (value != null) {
                        wrapper.between(column, rangeStart(value), rangeEnd(value));
                    }
                    break;
                case IS_NULL: wrapper.isNull(column); break;
                case IS_NOT_NULL: wrapper.isNotNull(column); break;
                default: break;
            }
        }
    }
